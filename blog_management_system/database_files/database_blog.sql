...
CREATE TABLE `user login` (
  `usertime_id` int(11) NOT NULL AUTO_INCREMENT,
  `username` varchar(50) DEFAULT NULL,
  `login_time` time DEFAULT NULL,
  `logout_time` time DEFAULT NULL,
  PRIMARY KEY (`usertime_id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

/*Data for the table `user login` */

insert  into `user login`(`usertime_id`,`username`,`login_time`,`logout_time`) values 
(1,'haya','08:00:00','09:00:00'),
(2,'fatima','07:00:00','10:00:00');
...
(1,'Admin Hira','Female','admin@gmail.com','12345','Active'),
(2,'Author Saira','Female','author_saira@gmail.com','12345','Active'),
